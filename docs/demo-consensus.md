...
#### New Height
- [Node 0](../res/demo-consensus/log-tendermint-node0#L56)
- [Node 1](../res/demo-consensus/log-tendermint-node1#L51)
- [Node 2](../res/demo-consensus/log-tendermint-node2#L54)
- [Node 3](../res/demo-consensus/log-tendermint-node3#L63)

Nodes started the algorithm to validate a new block (at new height).

#### Propose
- [Node 0](../res/demo-consensus/log-tendermint-node0#L57)
- [Node 1](../res/demo-consensus/log-tendermint-node1#L52)
- [Node 2](../res/demo-consensus/log-tendermint-node2#L55)
- [Node 3](../res/demo-consensus/log-tendermint-node3#L64)
...
- [Node 0](../res/demo-consensus/log-tendermint-node0#L61)
- [Node 1](../res/demo-consensus/log-tendermint-node1#L55)
- [Node 2](../res/demo-consensus/log-tendermint-node2#L64)
- [Node 3](../res/demo-consensus/log-tendermint-node3#L67)
...
- [Node 0](../res/demo-consensus/log-tendermint-node0#L67)
- [Node 1](../res/demo-consensus/log-tendermint-node1#L71)
- [Node 2](../res/demo-consensus/log-tendermint-node2#L70)
- [Node 3](../res/demo-consensus/log-tendermint-node3#L75)
...
### Commit
- [Node 0](../res/demo-consensus/log-tendermint-node0#L84)
- [Node 1](../res/demo-consensus/log-tendermint-node1#L84)
- [Node 2](../res/demo-consensus/log-tendermint-node2#L85)
- [Node 3](../res/demo-consensus/log-tendermint-node3#L86)
...
- [Node 0](../res/demo-consensus/log-tendermint-node0#L210)
- [Node 1](../res/demo-consensus/log-tendermint-node1#L208)
- [Node 2](../res/demo-consensus/log-tendermint-node2#L209)
- [Node 3](../res/demo-consensus/log-tendermint-node3#L209)
...
- [Node 0](../res/demo-consensus/log-tendermint-node0#L162)
- [Node 1](../res/demo-consensus/log-tendermint-node1#L163)
- [Node 2](../res/demo-consensus/log-tendermint-node2#L167)
- [Node 3](../res/demo-consensus/log-tendermint-node3#L169)


The main differences are about [the block data](../res/demo-consensus/log-tendermint-node0#L228):
